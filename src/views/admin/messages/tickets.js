...
import OpenTicketAdminForm from "../../../containers/form-validations/OpenTicketAdminForm";
...
export default class Tickets extends Component {
    ...
    getTickets() {
        axios.get(config.api.url + '/admin/ticket/u/list/' + localStorage.getItem("user_id"))
            .then((res) => {
                if (res.status === 200) {
                    this.setState({
                        tickets: res.data,
    ...
    deleteTicket() {
        axios.post(config.api.url + '/admin/ticket/delete/' + this.state.selectedId)
            .then((res) => {
                if (res.status === 200) {
            ...
            <Fragment>
                ...
                >
                    ...
                    <ModalBody style={{ textAlign: "center" }}>
                        <OpenTicketAdminForm refreshTickets={this.getTickets} hideModal={this.hideModal} />
                    </ModalBody>
                </Modal>
